#!/usr/bin/python
#Shift5endOffset_BED14RPF_MNase.py
...
#This is modified for MNase treated bed14 data, with col14 = predicted P site
#Suggested output name: BED13.XntShifted.RPF
#Version: Yu Sun, 2018-09-27 
#Version: Yu Sun, 2018-12-29
#Version: Modified, 2021-11
...
if len(sys.argv) != 3: #if the length of argv is not equal to 3
    print("This script takes RPF bed14 file as input (col14 is Y/N 5end mismatch tag), modify the reads based on the Random Forest predicted P offset stored in col14.")
    ...
    print("This is modified for MNase treated bed14 data, with col14 = predicted P site")
    print("Usage: [Shift5endOffset_BED14RPF_MNase.py] [BED14.RPF] [Output|BED13.XShifted.RPF]")
